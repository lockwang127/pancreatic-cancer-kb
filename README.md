...
基于知识三元组（head-relation-tail）的胰腺癌结构化知识图谱，支持 RAG/LLM/AI 应用集成。

## 知识覆盖

| 知识域 | 文件 | 描述 |
|--------|------|------|
| 流行病学 | `epidemiology.json` | 发病率、死亡率、病理类型、危险因素 |
| 分期与生物标志物 | `biomarkers.json` | TNM分期、切除性分类、基因突变、肿瘤标志物 |
| CSCO 2024指南 | `csco_2024.json` | CSCO指南推荐方案 |
| 治疗方案 | `treatment.json` | 手术、化疗、放疗、支持治疗、随访 |
