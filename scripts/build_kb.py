#!/usr/bin/env python3
"""Build pancreatic cancer knowledge base from JSON triplet files."""
...
def build_kb():
    ...
    print("=" * 60)
    print("Pancreatic Cancer Knowledge Base Builder")
    print("=" * 60)
    ...
    kb = {
        "meta": {
            "name": "pancreatic-cancer-kb",
            "description": "胰腺癌结构化知识库",
            "version": "1.0.0",
